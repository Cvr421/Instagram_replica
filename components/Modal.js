...
function Modal() {
  ...
  const uploadPost = async () => {
    if (loading) return;
    setLoading(true);
    // create a post and add to firestre 'posts ' collection
    // get the post ID for the newly creeated post
    // upload the image to firebase storage with the pot ID
